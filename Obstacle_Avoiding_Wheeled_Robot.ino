 ...
 * Created 2023
 * By Digvijay Patil
 * Last Modified 07/25/2023 by Kamil Gozalov
 * Version 2.1
 *
 *
 * This project aims to educate the user on how connect an Ultrasonic sensor 
 * and demonstrate how this sensor can help a 2WD car avoid obstacles.
 * 
 *
 * https://snappyxo.io/
...
// randomly choose whether to turn left or right if an obstacle is encountered; in this code, 0 is turning right and 1 is turning left
