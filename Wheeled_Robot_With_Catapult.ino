 ...
 *
 *
 * This project aims to educate the user on how to connect two servos 
 * and demonstrate their uses and limits with a catapult on a 2WD car.
 * 
 * 
 *
 * https://snappyxo.io/
...
//When robot becomes to close to the obstacle; Robot will reverse, turn right, then continue forward
 if (inches < 7 && randint == 0) {
  ...
  for (pos = 0; pos <= 90; pos += 10)  // goes from 0 degrees to 90 degrees in steps of 1 degree
  {
  catapult.write(pos);
  delay(5);
  }     
  ...
  chute.write(80);
  delay(100);
  chute.write(140); //chute releases ball
  delay(100);
  chute.write(80);
  pause();
  delay(500);
